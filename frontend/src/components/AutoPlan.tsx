...
//TODO Реализовать возможность редактирования распознанных мероприятий (название, дата, ответственный) прямо в таблице перед генерацией задач
//TODO Реализовать возможность добавления напоминания (за сколько дней до мероприятия) прямо в таблице перед генерацией задач
//TODO Реализовать отображение иерархии мероприятий (если в документе есть вложенные пункты) и возможность её редактирования (сдвигать мероприятия вправо/влево для изменения уровня вложенности)